...
class BuscarFilaAtendimentoPorIdOuCpfUseCaseTest {
    ...
    class QuandoBuscarPorCpf {
        ...
        void deveRetornarDTOQuandoEncontrarFilaPorCpf() {
            ...
            when(filaAtendimentoRepository.findByTriagem_Paciente_CpfAAndStatusAtendimentoEnum(cpf,StatusAtendimentoEnum.PENDENTE)).thenReturn(Optional.of(fila));
        ...
        void deveLancarExcecaoQuandoNaoEncontrarFilaPorCpf() {
            String cpf = "12345678901";
            when(filaAtendimentoRepository.findByTriagem_Paciente_CpfAAndStatusAtendimentoEnum(cpf,StatusAtendimentoEnum.PENDENTE)).thenReturn(Optional.empty());
